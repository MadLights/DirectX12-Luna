...
namespace d3dUtil
{
    ...
    constexpr UINT CalcConstantBufferByteSize(const UINT byteSize)
    {
...
struct MaterialConstants final
{
	...
	float Roughness = 0.25f; // range [0,1]
...
{                                                                     \
    ...
    if(FAILED(hr__)) [[unlikely]] { throw DxException(hr__, L#x, AnsiToWString(__FILE__), __LINE__); } \
}
#endif
