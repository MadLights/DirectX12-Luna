//***************************************************************************************
// Chapter 08 Exercise 03: Demo using three point lighting.
// 
...
void LitColumnsApp::BuildFrameResources()
{
    ...
    lightConstants.AmbientLight = { 0.25f, 0.25f, 0.35f, 1.0f };
    lightConstants.Lights[0].Direction = { 0.57735f, -0.57735f, 0.57735f };
    lightConstants.Lights[0].Strength = { 0.6f, 0.6f, 0.6f };
    lightConstants.Lights[1].Direction = { -0.57735f, -0.57735f, 0.57735f };
    lightConstants.Lights[1].Strength = { 0.3f, 0.3f, 0.3f };
    lightConstants.Lights[2].Direction = { 0.0f, -0.707f, -0.707f };
    lightConstants.Lights[2].Strength = { 0.15f, 0.15f, 0.15f };
    ...
    for (auto& fr : mFrameResources)
    {
        ...
        fr->LightCB->CopyData(0, lightConstants);
    }
}
