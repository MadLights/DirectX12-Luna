//***************************************************************************************
// Chapter 07 Exercise 01: Use a geosphere instead of a sphere.
//
...
void ShapesApp::BuildShapeGeometry()
{
    ...
    UINT cylinderVertexOffset = sphereVertexOffset + (UINT)geoSphere.Vertices.size();

    // Cache the starting index for each object in the concatenated index buffer.
    UINT boxIndexOffset = 0;
    UINT gridIndexOffset = (UINT)box.Indices32.size();
    UINT sphereIndexOffset = gridIndexOffset + (UINT)grid.Indices32.size();
    UINT cylinderIndexOffset = sphereIndexOffset + (UINT)geoSphere.Indices32.size();
    ...
    sphereSubmesh.IndexCount = (UINT)geoSphere.Indices32.size();
