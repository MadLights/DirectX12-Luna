//***************************************************************************************
// Chapter 06 Exercise 04: Drawing a pyramid
// 
...
class PyramidApp final : public D3DApp
{
public:
...
void PyramidApp::Draw(const GameTimer& gt)
{
    ...
    const D3D12_VERTEX_BUFFER_VIEW vertexBuffView = mPyramidGeo->VertexBufferView();
    const D3D12_INDEX_BUFFER_VIEW indexBuffView = mPyramidGeo->IndexBufferView();
...
void PyramidApp::BuildPyramidGeometry()
{
    ...
    constexpr std::array<std::uint16_t, 18> indices = {
        0, 2, 1,
        1, 2, 3,
        0, 4, 2,
        1, 4, 0,
    ...
    mPyramidGeo->DrawArgs.emplace("pyramid", submesh);
}
