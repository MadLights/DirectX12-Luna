//***************************************************************************************
// Chapter 06 Exercise 06: Animate box based on time.
//
...
{
    mFrameCB->CopyData(0, { gt.TotalTime() });
}
...
void BoxApp::BuildConstantBuffers()
{
    ...
    cbvDesc.BufferLocation = mFrameCB->Resource()->GetGPUVirtualAddress();
    cbvDesc.SizeInBytes = d3dUtil::CalcConstantBufferByteSize(sizeof(FrameConstants));
    md3dDevice->CreateConstantBufferView(
        &cbvDesc,
        cbvHeapHandle);
}
