...
{
    constexpr D3D12_RENDER_TARGET_BLEND_DESC redGreenFilterOut = {
    ...
    opaquePsoDesc.BlendState.RenderTarget[0] = redGreenFilterOut;
    ...
    alphaTestedPsoDesc.BlendState.RenderTarget[0] = redGreenFilterOut;
