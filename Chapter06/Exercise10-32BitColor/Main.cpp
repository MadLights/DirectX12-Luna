//***************************************************************************************
// Chapter 06 Exercise 10: Use 32 colors instead of 128 bit.
//
...
void BoxApp::Draw(const GameTimer&)
{
    ...
    const D3D12_VERTEX_BUFFER_VIEW vertexBuffView = mBoxGeo->VertexBufferView();
    const D3D12_INDEX_BUFFER_VIEW indexBuffView = mBoxGeo->IndexBufferView();
...
void BoxApp::BuildShadersAndInputLayout()
{
    ...
    mInputLayout[1] = { "COLOR", 0, DXGI_FORMAT_B8G8R8A8_UNORM, 0, 12, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 };
}
...
void BoxApp::UpdateWorldViewProj()
{
    ...
    const XMMATRIX worldViewProj = 
        XMLoadFloat4x4(&mWorld) * view * XMLoadFloat4x4(&mProj);
